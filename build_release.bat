...
set CXXFLAGS=/std:c++14 /EHsc /W4 /WX /FC /MT /wd4996 /wd4201 /nologo /O2 /DNDEBUG %*
...
for %%i in (.\code\*) do cl %CXXFLAGS% %INCLUDES% ".\code\%%~ni.cpp" /Fo:build\ /Fe:build\%%~ni.exe /link %LIBS% /SUBSYSTEM:WINDOWS
